...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div id="boxevent" class="container-fluid">
        <div class="container bkbox">
            <div class="frmbox">
                <div class="titlebox">
                    <p class="tittle">Registrar Evento</p>
                </div>
                <div class="controlbox">
                    ...
                    <div class="row pb-3">
                        <div class="col-md-1"></div>
                        <div class="col-md-10"><asp:TextBox ID="txtDescripcion" CssClass="form-control form-control-sm" runat="server" TextMode="MultiLine"></asp:TextBox></div>
                        <div class="col-md-1"></div>
                    </div>
                    <div class="row">
                        <div class="col-md-1"></div>
                            ...
                            <asp:GridView ID="gZona" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Zona">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtZona" CssClass="form-control form-control-sm" runat="server" AccessKey=""></asp:TextBox>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Cantidad Máximo">
                                        <ItemTemplate>
                                            <asp:TextBox ID="txtCantidad" CssClass="form-control form-control-sm" runat="server"></asp:TextBox>
                                        </ItemTemplate>
