<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Perfil.aspx.cs" Inherits="PortalEventus.Perfil" %>
...
<div style="position: absolute; left:10%; top:20%" id="capa1">
    <form id="form" runat="server">
        <table>
            ...
            <tr id="trContrasenaActual" runat="server">
                <td>Contrase;a</td>
                <td>
                    <asp:Label ID="lblContrasena" runat="server" Text=""></asp:Label>
                </td>
                <td>
                    <asp:LinkButton ID="lnkActualizarContrasena" runat="server">Cambiar</asp:LinkButton>
                </td>
            </tr>
            <tr id="trContrasena" runat="server">
                <td>Contrase;a actual</td>
                <td>
                    <asp:TextBox ID="txtContrasenaActual" runat="server"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>Nueva contrasena</td>
                <td>
